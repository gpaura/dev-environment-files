# Generated by Powerlevel10k configuration wizard on 2025-04-04 at 17:09 -03.
...
# 12h time, 2 lines, dotted, no frame, black-ornaments, compact, many icons, fluent,
...
() {
  ...
  # The color of the prompt. This is the color of the first character of the prompt.
  # Colorize prompt
  typeset -g POWERLEVEL9K_DIR_DEFAULT_FOREGROUND=004
  typeset -g POWERLEVEL9K_DIR_HOME_FOREGROUND=005
  typeset -g POWERLEVEL9K_DIR_HOME_SUBFOLDER_FOREGROUND=006
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=166
  # Custom icon.
  ...
  # Insert mode (normal typing) - right arrow
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='➜'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='✗'

  # Command mode (after jj) - left arrow
  ...
  # Most popular Git branch icon
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='\UE0A0 '         #   Git branch icon (with a space)
  typeset -g POWERLEVEL9K_VCS_BRANCH_NAME_FOREGROUND=220
  # Common Git status icons
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='●'            # Untracked files
  typeset -g POWERLEVEL9K_VCS_MODIFIED_ICON='✚'             # Modified files
  typeset -g POWERLEVEL9K_VCS_STAGED_ICON='✔'               # Staged files
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_ICON='⚠'           # Merge conflicts
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='\uF059 '   #   (question circle) #   (info circle)
  ...
  # Mudar aqui
  # Change Git Branch Icon Color from 33 to 5 (bright purple)
typeset -g POWERLEVEL9K_VCS_BRANCH_ICON_COLOR=5

# Change Branch Name Color from 208 (orange) to 213 (light pink)
typeset -g POWERLEVEL9K_VCS_BRANCH_NAME_FOREGROUND=213

# Make Git Status Icons more distinctive
typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='✚'  # Plus sign for untracked files
typeset -g POWERLEVEL9K_VCS_MODIFIED_ICON='!'   # Exclamation for modified files  
typeset -g POWERLEVEL9K_VCS_STAGED_ICON='↗'     # Arrow for staged files
typeset -g POWERLEVEL9K_VCS_CLEAN_ICON='✓'      # Check mark for clean status

# Change the visual elements color to pink (198)
typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=198

# Change the time color from yellow (220) to pink (198)
typeset -g POWERLEVEL9K_TIME_FOREGROUND=198

# You can also change the format of the time display if you'd like
# typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%H:%M:%S}'

# Enhanced Git visual cues - improved colors and contrast
typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=2              # Bright green for clean
typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=""
typeset -g POWERLEVEL9K_VCS_CLEAN_VISUAL_IDENTIFIER_COLOR=2

# Modified files - orange/yellow for attention
...
# Untracked files - red for immediate attention
typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=1          # Red for untracked
typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=""
typeset -g POWERLEVEL9K_VCS_UNTRACKED_VISUAL_IDENTIFIER_COLOR=1

# Staged files - cyan for ready to commit
typeset -g POWERLEVEL9K_VCS_STAGED_FOREGROUND=6             # Cyan for staged
typeset -g POWERLEVEL9K_VCS_STAGED_BACKGROUND=""
typeset -g POWERLEVEL9K_VCS_STAGED_VISUAL_IDENTIFIER_COLOR=6

# Conflicted files - bright red for urgent attention
typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND=9         # Bright red for conflicts
typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=""
typeset -g POWERLEVEL9K_VCS_CONFLICTED_VISUAL_IDENTIFIER_COLOR=9
  ...
  # Branch icon color ()
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='\uE0A0 '  # keeps branch icon
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON_COLOR=33  # blue, try 208 for orange

  # Branch name color ("master")
  typeset -g POWERLEVEL9K_VCS_BRANCH_NAME_FOREGROUND=208  # orange

  # Disable the default Git status formatting.
  typeset -g POWERLEVEL9K_VCS_DISABLE_GITSTATUS_FORMATTING=true

  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=198
  typeset -g POWERLEVEL9K_LEFT_PROMPT_PADDING_FOREGROUND=220

  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='·'
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_FOREGROUND=220
  # Até aqui

  # Bold time display
  typeset -g POWERLEVEL9K_TIME_CONTENT_EXPANSION='%B$P9K_CONTENT'
  # Force bold styling for git status icons
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='%B$P9K_CONTENT'
  typeset -g POWERLEVEL9K_VCS_LOADING_CONTENT_EXPANSION='%B$P9K_CONTENT'

  # Enable counters for staged, unstaged, etc.
  typeset -g POWERLEVEL9K_VCS_{STAGED,UNSTAGED,UNTRACKED,CONFLICTED,COMMITS_AHEAD,COMMITS_BEHIND}_MAX_NUM=-1

  # Force bold command execution time
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_CONTENT_EXPANSION='%B$P9K_CONTENT'
  
  # Bold status indicators
  typeset -g POWERLEVEL9K_STATUS_OK_CONTENT_EXPANSION='%B$P9K_CONTENT'
  typeset -g POWERLEVEL9K_STATUS_ERROR_CONTENT_EXPANSION='%B$P9K_CONTENT'
  
    # Bold background jobs indicator
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_CONTENT_EXPANSION='%B$P9K_CONTENT'
  
  # Force bold user name and host
  typeset -g POWERLEVEL9K_USER_CONTENT_EXPANSION='%B$P9K_CONTENT'
  typeset -g POWERLEVEL9K_HOST_CONTENT_EXPANSION='%B$P9K_CONTENT'
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_VCS_PREFIX='%f on '
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%A, %B %d %Y – %I:%M:%S %p}'
  ...
  # Cache directory location for better performance
  typeset -g POWERLEVEL9K_CACHE_FILE=${XDG_CACHE_HOME:-$HOME/.cache}/p10k-$(whoami)
